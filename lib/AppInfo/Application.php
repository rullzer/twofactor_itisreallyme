...
namespace OCA\TwoFactorItIsReallyMe\AppInfo;

use OCA\TwoFactorItIsReallyMe\Event\StateChanged;
use OCA\TwoFactorItIsReallyMe\Listener\IListener;
use OCA\TwoFactorItIsReallyMe\Listener\RegistryUpdater;
use OCP\AppFramework\App;
use Symfony\Component\EventDispatcher\EventDispatcherInterface;

class Application extends App {
	const APP_ID = 'twofactor_itisreallyme';
